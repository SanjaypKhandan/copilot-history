...
exports.ConversationWebviewPanel = void 0;
...
class ConversationWebviewPanel {
    ...
    panel;
    disposables = [];
    constructor(conversationId, extensionUri) {
        this.conversationId = conversationId;
        this.extensionUri = extensionUri;
        this.panel = vscode.window.createWebviewPanel('copilotHistory.conversation', 'Conversation', vscode.ViewColumn.One, { enableScripts: false, retainContextWhenHidden: false });
    ...
    static show(conversationId, conversation, extensionUri) {
...
exports.ConversationWebviewPanel = ConversationWebviewPanel;
/* ------------------------------------------------------------------ */
/*  HTML escape                                                        */
/* ------------------------------------------------------------------ */
